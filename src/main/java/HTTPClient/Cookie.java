 ...
 *  Copyright (C) 1996-2001 Ronald Tschal채r
 *
...
public class Cookie implements Serializable {
     ...
     * @throws NullPointerException if <var>name</var>, <var>value</var>, <var>domain</var>,
    ...
    protected static Cookie[] parse(String set_cookie, RoRequest req)
        ...
        if (set_cookie.toLowerCase().indexOf("httponly") != -1) {
            ...
            // and all instances of HttpOnly following a semi-colon at the end
            // of
            ...
            while (true) // parse all parts
            {
                ...
                if (beg + 8 <= len
                    ...
                    if (beg < len && buf[beg] == ';') // consume ";"
                        beg = Util.skipSpace(buf, beg + 1);
                    /** NGRINDER_MODIFICATION */
                    else if (beg < len
                            && set_cookie.regionMatches(true, beg, "=1;", 0, 3)) {
                        beg = Util.skipSpace(buf, beg + 3);
    ...
    private static boolean setAttribute(Cookie cookie, String name,
        ...
        } else if (name.equals("max-age")) // from rfc-2109
        {
            ...
            /** ++GRINDER MODIFICATION **/
            // Despite Ronald's comment above, RFC-2965 is not followed in
            // practice.
            // Browsers seem to be adopting increasingly complicated heuristics
            // for
            ...
            if (false) {
                ...
                if (top == null
                    ...
                    if (dl > vl
                        ...
                        Log.write(Log.COOKI, "Cooki: Bad Set-Cookie header: "
                                + set_cookie + "\n       Domain attribute "
                                + value + "is more than one level below "
